...
public abstract class InteractiveTileObject  {
    ...
    public TiledMapTileLayer.Cell getCell(){
        TiledMapTileLayer layer = (TiledMapTileLayer) map.getLayers().get(B2WorldCreator.GRAPHICS_LAYER);
        return layer.getCell((int)(body.getPosition().x * GdxGame.PPM / 16),
                (int)(body.getPosition().y * GdxGame.PPM / 16));
    }
