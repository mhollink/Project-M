...
public class Mario extends Sprite {
    ...
    public void update(float dt){
        ...
        if(marioIsBig)
            setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - getHeight() / 2 - 6 / GdxGame.PPM);
        else
    ...
    public void grow(){
        if( !isBig() ) {
            ...
            GdxGame.manager.get(GdxGame.SFX_POWER_UP_USED, Sound.class).play();
        }
    }
    ...
    public void die() {
        ...
        if (!isDead()) {
            ...
            GdxGame.manager.get(GdxGame.SFX_MUSIC, Music.class).stop();
            GdxGame.manager.get(GdxGame.SFX_DIE, Sound.class).play();
            marioIsDead = true;
            Filter filter = new Filter();
            filter.maskBits = GdxGame.NOTHING_BIT;
    ...
    public void jump(){
        if ( currentState != State.JUMPING && currentState != State.FALLING ) {
            ...
            if(isBig()) GdxGame.manager.get(GdxGame.SFX_JUMP_BIG, Sound.class).play();
            else GdxGame.manager.get(GdxGame.SFX_JUMP_SMALL, Sound.class).play();
        }
    }
    ...
    public void redefineMario(){
        ...
        head.set(new Vector2(-2 / GdxGame.PPM, 8 / GdxGame.PPM), new Vector2(2 / GdxGame.PPM, 8 / GdxGame.PPM));
        fdef.filter.categoryBits = GdxGame.MARIO_HEAD_BIT;
        fdef.shape = head;
        fdef.isSensor = true;
    ...
    public void defineBigMario(){
        ...
        BodyDef bdef = new BodyDef();
        bdef.position.set(currentPosition.add(0, 10 / GdxGame.PPM));
        bdef.type = BodyDef.BodyType.DynamicBody;
        b2body = world.createBody(bdef);
        ...
        fdef.shape = shape;
        b2body.createFixture(fdef).setUserData(this);
        shape.setPosition(new Vector2(0, -16 / GdxGame.PPM));
        b2body.createFixture(fdef).setUserData(this);
    ...
    public void defineMario(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(32 / GdxGame.PPM, 32 / GdxGame.PPM);
        bdef.type = BodyDef.BodyType.DynamicBody;
        b2body = world.createBody(bdef);
